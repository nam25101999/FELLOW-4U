...
class _CreateTripScreenState extends State<CreateTripScreen> {
  ...
  final TextEditingController _langController = TextEditingController(text: 'Korean, English');
  ...
  final List<Map<String, dynamic>> _selectedAttractions = [
    ...
    {
      'name': 'Cham Museum',
      'imageUrl': 'http://127.0.0.1:8080/uploads/location/images_1.jpg',
      'isSelected': false,
    },
    {
      'name': 'My Khe Beach',
      'imageUrl': 'http://127.0.0.1:8080/uploads/location/tai_xuong_4.jpg',
      'isSelected': true,
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create New Trip', style: AppTypography.subtitle1),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildInputField('Where you want to explore', 'Location', _locationController, Icons.location_on),
            ...
            SizedBox(height: 24.h),
            _buildInputField('Fee', 'Fee (\$/hour)', _feeController, Icons.attach_money),
            SizedBox(height: 24.h),
            _buildInputField('Guide\'s Language', 'Languages', _langController, Icons.language),
            ...
            ElevatedButton(
              onPressed: () {
                SuccessDialog.show(
                  context,
                  title: 'Trip Created!',
                  message: 'Your custom trip has been created successfully.\nCheck it in My Trips!',
  ...
  Widget _buildAddButton() {
    return GestureDetector(
      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const AddAttractionScreen())),
      child: Container(
        decoration: BoxDecoration(
  ...
  Widget _buildAttractionCard(Map<String, dynamic> attraction) {
    return Stack(
      children: [
        ...
        Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(12.r), color: Colors.black26)),
        Positioned(
          bottom: 8.h,
          left: 8.w,
          right: 8.w,
